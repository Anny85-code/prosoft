...
const fakeData = [
    {
        ...
        subHeading: 'Windows, Computers, System, Software, Choice, Accounting, Printer, VISTA',
        card: {
                client: 'Paula Tekle',
        ...
        para1: 'Darts is a sporting goods company that has most of its outlets in the western states. The company computers are connected to each other via network. A network has 273 computers and it consists of the following hardware systems.8 Windows Server 2003 R2 Servers 2 Linux Servers running Red Hat Linux Enterprise 20 computers running MAC OS X version 10.4 Tiger 32 computers with Windows XP installed 126 computers with Windows Vista installed 95 computers with Windows 7 installed With advancements in the growth of the company, the network requires upgrading and modifications. Therefore, the company is focusing on the upgrade of servers, computer systems, and software programs.',
        para2: 'The Accounting department of the company has Windows XP installed in all of the computers. The accounting director of the department wants to upgrade the operating system Windows 7. The department would get certain benefits through an upgrade of the operating system that are discussed as follows',
        para3: 'First, the Windows 7 provides a great user-friendly interface for all the users to perform their desired tasks. The design of taskbar and system trays are much user-friendly compared to the Windows XP.',
        summary: 'However, anyone who was more comfortable with the Windows XP outlook can choose an option to change design of Windows 7 back to XP. Other interesting features that are most beneficial for the businesses are the desktop slideshow and screen savers. The accounting department users may activate the desktop slideshow to most recent financial statements and thus, keep a regular check. The bookkeeping and other accounting functions flourish with this feature of the Windows 7',
        img1: projectImg1,
        img2: projectImg2,
    },
    {
